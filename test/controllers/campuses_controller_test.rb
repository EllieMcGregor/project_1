...
class CampusesControllerTest < ActionController::TestCase
  ...
  test "should create campus" do
    assert_difference('Campus.count') do
      post :create, campus: { description: @campus.description, image: @campus.image, location: @campus.location, name: @campus.name }
    end
  ...
  test "should update campus" do
    patch :update, id: @campus, campus: { description: @campus.description, image: @campus.image, location: @campus.location, name: @campus.name }
    assert_redirected_to campus_path(assigns(:campus))
  end
