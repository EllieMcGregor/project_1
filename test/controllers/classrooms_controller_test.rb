...
class ClassroomsControllerTest < ActionController::TestCase
  ...
  test "should create classroom" do
    assert_difference('Classroom.count') do
      post :create, classroom: { campus_id: @classroom.campus_id, capacity: @classroom.capacity, room_name: @classroom.room_name }
    end
  ...
  test "should update classroom" do
    patch :update, id: @classroom, classroom: { campus_id: @classroom.campus_id, capacity: @classroom.capacity, room_name: @classroom.room_name }
    assert_redirected_to classroom_path(assigns(:classroom))
  end
